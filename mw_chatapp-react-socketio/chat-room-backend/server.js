...
const mongoURI = `mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@cluster0.htktv52.mongodb.net/${process.env.MONGO_DATABASE_NAME}?retryWrites=true&w=majority`;
